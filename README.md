...
6. [Static Site Regeneration](#static-site-regeneration)
7. [Commits & Commitizen](#commits--commitizen)
   - [Making a Commit](#making-a-commit)
8. [Linting & Formatting](#linting--formatting)
   - [Linting Commands](#linting-commands)
   - [Formatting Commands](#formatting-commands)
   - [Pre-Commit Hook](#pre-commit-hook)
9. [Unit Tests & Code Coverage](#unit-tests--code-coverage)
   - [Unit Tests](#unit-tests)
   - [Code Coverage](#code-coverage)
10. [Error & Performance Metrics](#error--performance-metrics)
   - [Configuration](#configuration)
   - [Source Maps](#source-maps)
11. [Development Website Proxy](#development-website-proxy)
    - [Environment Variables](#environment-variables)
    - [Running The Proxy](#running-the-proxy)
12. [E2E Tests](#e2e-tests)
    - [Configuration](#configuration)
...
17. [Deployment Pipelines](#deployment-pipelines)
...
AI agents and contributors MUST start with **[`CONTEXT.md`](CONTEXT.md)** (mandatory reading order and non-negotiable constraints), then **[`AGENTS.md`](AGENTS.md)** and the docs under [`docs/`](docs/).

- PR review severity tiers: [`docs/REVIEW.md`](docs/REVIEW.md)
- Contribution workflow: [`docs/CONTRIBUTING.md`](docs/CONTRIBUTING.md)
- Quality commands: run `make help` or `make preflight`

Human-oriented setup and ops detail continue in the sections below; do not duplicate agent rules here.

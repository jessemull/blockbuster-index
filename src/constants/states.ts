...
export type USAStateAbbreviation = (typeof StateAbbreviations)[number];

export const StateNames: Record<USAStateAbbreviation, string> = {
  AL: 'Alabama',
  AK: 'Alaska',
  AZ: 'Arizona',
  AR: 'Arkansas',
...
export const StatePaths: Record<USAStateAbbreviation, string> = {

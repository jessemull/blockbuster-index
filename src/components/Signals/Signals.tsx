      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-8 md:py-16 flex-1 flex flex-col">
        ...
        <div className="flex flex-col items-center gap-6 mb-10">
          {SIGNAL_KEYS.map((key) => (
            <div
              key={key}
              className="bg-brand-dark-blue border border-brand-yellow rounded-lg px-6 py-4 max-w-xl w-full shadow-md"
            >
              <div className="text-brand-yellow font-semibold text-lg mb-1">
                {SIGNAL_LABELS[key]}
              </div>

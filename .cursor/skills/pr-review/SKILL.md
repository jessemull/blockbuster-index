...
name: pr-review
description: >-
  Review PRs for Blockbuster Index: diff-first, severity-tiered task lists. Use when reviewing a PR or branch.
---
...
2. **Architecture** — OK or concern (static export, layers, data contract)
...
Companion skills: `security-review`, `accessibility-review`, `testing`, `chart-components`, `static-export`.
